...
et le tag vers `jeansittler/Physalix`. À partir de 1.2.0, créer la Release dans ce
même dépôt et joindre les notes, l'installateur et `update.json` (SHA-256 séparé
facultatif). Voir `RELEASE.md` pour les commandes.
